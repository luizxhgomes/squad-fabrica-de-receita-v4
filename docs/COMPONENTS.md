...
| `retention-playbook.md` | Retention Playbook |
| `roi-analysis.md` | roi-analysis |
| `ai-automation.md` | AI Marketing Automation Blueprint |
| `growth-experiment.md` | Growth Experiment Framework |
| `weekly-performance.md` | Ritual Semanal de Performance |
| `trava-diagnostico.md` | Trava Diagnostico |
| `trava-identificacao.md` | Trava Identificacao |
| `step-framework.md` | STEP Framework |
| `90-day-cycle.md` | 90-Day Cycle |
| `revenue-architecture.md` | Revenue Architecture |
| `destrava-pitch.md` | Destrava Pitch |
| `diagnosticar-trava.md` | Diagnosticar Trava |
| `executar-board-1.md` | Executar Board 1 |
| `executar-board-2.md` | Executar Board 2 |
| `gerar-artefato.md` | Gerar Artefato |
| `unit-economics.md` | Unit Economics: cálculo canônico de LTV, CAC e payback |
| `forecast-receita.md` | Forecast de receita: projeção de 90 dias em 3 cenários |
| `monitor-regressao.md` | Monitor de regressão: snapshot semanal contra baseline |
...
| Componente | Titulo / Descricao |
|---|---|
| `anti-no-show.skill.md` | anti-no-show: Régua anti-no-show de 7 pontos com scripts prontos para a trava |
| `objections-arsenal.skill.md` | objections-arsenal: Arsenal de fechamento com as 10 objeções mais comuns do DR-X, tratadas |
| `spiced-framework.skill.md` | spiced-framework: Framework SPICED de qualificação comercial (Situation, Pain, Impact, |
| `toc-aplicada.skill.md` | toc-aplicada: Teoria das Restrições (TOC) aplicada ao sistema de receita. Recebe o |
| `diagnostico-8-travas.skill.md` | diagnostico-8-travas: Diagnóstico científico das 8 travas do sistema de receita. Recebe as |
| `ciclo-90-dias.skill.md` | ciclo-90-dias: Planejamento e gestão do ciclo de 90 dias dedicado a 1 trava. Recebe a |
| `pricing-tiers-dr.skill.md` | pricing-tiers-dr: Recomendação de produto do portfólio Destrava Receita (DR-X, DR-O, |
| `ltp-arvores-logicas.skill.md` | ltp-arvores-logicas: Aplicação do LTP (Lean Thinking Process) com as árvores lógicas da |
| `icp-scoring.skill.md` | icp-scoring: Scoring de ICP do Destrava Receita. Recebe dados firmográficos e |
| `benchmark-funil.skill.md` | benchmark-funil: Comparação das métricas atuais do funil contra os benchmarks de |

## Data (knowledge base) (8)
...
| `spiced-template.md` | Template: SPICED: Framework de Qualificação |
...
_Total: 88 componentes indexados em 7 categorias._
